    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <main className="pt-28 pb-20">
        <div className="container-1200 px-6 text-center">
          ...
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.2, duration: 0.5 }} className="mx-auto mt-4 max-w-2xl text-white/60">
            Preparing pricing…
          </motion.p>
        </div>
  ...
  return (
    <div className={["relative p-6 sm:p-8 w-full rounded-3xl border border-white/10 bg-black/30 backdrop-blur", highlight ? "ring-1 ring-purple-400/40" : ""].join(" ")}> 
      ...
      <div className="flex items-baseline gap-3">
        <div
          className={{ basic: "bg-white/20", standard: "bg-purple-500", premium: "bg-blue-500" }[variant] + " h-8 w-8 rounded-lg"}
        />
